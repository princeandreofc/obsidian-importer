# HEYGEN PRE-PRODUCTION PACK — HOLDING / CLAUDE

**Data:** 19/08/2026  
**Estado:** `DRAFT_FOR_APPROVAL` — pré-produção concluída; nenhum render autorizado  
...
| Filme | Palavras | Duração-alvo | Ritmo planejado |
|---|---:|---:|---|
| Puressência | 106 | 60 s | institucional calmo |
| Ali Love | 111 | 75 s | poético; espaço para música/motion |
| Prince Andre | 98 | 60 s | manifesto musical |
| AB Motion | 88 | 45 s | direto |
| AB Cream | 57 | 30 s | macro premium |
| Climbex | 95 | 60 s | explicativo |
| Trajetum | 93 | 60 s | humano/editorial |
| Dr. Brenno | 119 | 75 s | técnico e deliberado |
| Planning institucional | 97 | 60 s | informativo |
| Planning tutorial | 186 | 2–3 min | tutorial pausado |
| Impacto Digital | 79 | 45 s | manifesto curto |

O primeiro review deve medir duração real. Não acelerar a voz só para cumprir o tempo; ajustar texto e montagem depois da escuta.

## 5. Glossário de pronúncia — validar antes do render
...
Não enviar nenhum job enquanto houver item de pronúncia obrigatório sem confirmação.
...
O amor não é apenas o tema. É a força que atravessa a pista. Primeiro, um pulso no escuro. Depois, um sulco que se abre como portal. Fragmentos do acervo real encontram uma instalação cósmica sem apagar o artista, sem substituir sua presença e sem inventar uma nova história. O movimento cresce devagar: fumaça, órbita, reflexo e corpo coletivo. A imagem deixa de ser cenário e vira encontro. A campanha não promete uma fuga. Ela lembra por que ainda dançamos juntos. No último compasso, tudo converge para uma afirmação simples. Love Always Wins. Ali Love e AB Motion. Uma experiência construída com acervo real, direção de movimento e respeito à origem.
...
Um produto demonstrativo também precisa parecer verdadeiro. AB Cream é um estudo de marca, embalagem, textura e presença digital. O case explora materialidade, luz, tipografia e experiência sem inventar fórmula, registro, certificação ou eficácia. A imagem mostra como um sistema visual pode transformar uma ideia em presença reconhecível. Veja o processo de marca por trás da imagem.
...
1. Planning institucional — menor risco de identidade, assets prontos.
2. Impacto Digital — manifesto curto, voz-over.
3. Climbex — processo/BPM, sem pessoa identificável.
4. AB Motion — voz-over e cases autorizados.
5. Puressência — manifesto abstrato.
6. AB Cream — demonstrativo com disclosure.
7. Trajetum — depois de marca/claims aprovados.
8. Dr. Brenno — depois de pronúncia, claims e consentimento.
9. Ali Love — somente com mídia real e direitos.
10. Prince Andre — somente com mídia real, direitos e conceito aprovado.
11. Planning tutorial — depois do picture lock da interface e canal oficial.
